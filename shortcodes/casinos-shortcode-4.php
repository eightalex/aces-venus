...
function aces_casinos_shortcode_4($atts) {
	...
	<?php if ( $load_more_button ) { ?>
		...
		<style type="text/css">
			.space-organizations-3-archive-items .space-organizations-3-archive-item:nth-child(<?php echo esc_attr( $show_items ); ?>) ~ .space-organizations-3-archive-item {
			  display: none;
			}
		</style>
			...
			<?php if ( $load_more_button ) { ?>
				...
				<div class="space-load-more-button-wrap text-center box-100 relative">
					<div class="space-load-more-button-wrap-ins relative">
						<button class="space-load-more-button shortcode-load-more-4"><?php echo esc_html__( 'Load More', 'aces' ); ?></button>
					</div>
				</div>
